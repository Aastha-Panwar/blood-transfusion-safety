        ...
        <>
            <nav className="p-3 bg-white-900 sticky top-0 z-10 dark:bg-gray-bg">
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-between">
                        <>
                            <DropDown title="About Us" children={["About BTS", "Contact Us"]} links={["/about", "/contactUs"]}></DropDown>
                            {props.logIn ? (
                                <>
                                    <Link
                            ...
                            <button
                                className="theme_changer mx-2 px-3 py-2 rounded-full hover:shadow-lg"
                                onClick={() => {
